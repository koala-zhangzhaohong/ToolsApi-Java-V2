...
public class AcwUtils {
    private static final String ACW_MASK = "3000176000856006061501533003690027800375";

    private AcwUtils() {
    }

    public static String calculate(String arg1) {
        if (arg1 == null || arg1.isBlank()) {
            return null;
        }
        return hexXor(unsBox(arg1), ACW_MASK);
    }

    public static String unsBox(String arg1) {
        ...
        StringBuilder _0x12605e = new StringBuilder(arg1.length());
    ...
    public static String hexXor(String s1, String _0x4e08d8) {
        StringBuilder _0x5a5d3b = new StringBuilder(Math.min(s1.length(), _0x4e08d8.length()));
