...
public class KugouWebPathCollector {
    ...
    public static final String KUGOU_DETAIL_SERVER_URL_V1 = "https://wwwapi.kugou.com/yy/index.php";
    public static final String KUGOU_DETAIL_SERVER_URL_V2 = "http://trackercdn.kugou.com/i/v2/";
    public static final String KUGOU_DETAIL_SERVER_URL_V3 = "https://gateway.kugou.com/v3/url";
    public static final String KUGOU_DETAIL_SERVER_URL_V5 = "http://trackercdnbj.kugou.com/v5/url";
